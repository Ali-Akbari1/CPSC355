...
define(value_r, w22)                                                                            // Macro for value
define(i_r, w25)                                                                                // Macro for i
define(j_r, w27)                                                                                // Macro for j
define(count_r, w26)                                                                            // Macro for count
...
endEnqueue:                                                                                     // endEnqueue branch
    ...
    str             value_r,    [x28, w21, SXTW 2]                                              // Store value into the queue
...
dequeue:                                                                                        // Dequeue function
    ...
    ldr	            value_r,    [x28, w20, SXTW 2]                                              // value = queue[head]
...
display:                                                                                        // Display function
    ...
    sub             count_r,    w21,            w20                                             // count = tail - head
    add             count_r,    count_r,        1                                               // count += 1
    cmp             count_r,    0                                                               // Compare count with 0

    b.gt            next                                                                        // If it greater than 0 branch to next

    add             count_r,    count_r,        QUEUESIZE                                       // Add count and QUEUESIZE
...
top:                                                                                            // Top of the loop
    ...
    ldr             w1,         [x28, i_r, SXTW 2]                                              // Print queue
    bl              printf                                                                      // Call printf 

    cmp             i_r,        w20                                                             // Compare i with head
...
continue:                                                                                       // Continue branch
    cmp             i_r,        w21                                                             // Compare i and tail
...
after:                                                                                          // After branch
    ...
    add             i_r,        i_r,            1                                               // i+=1
    and             i_r,        i_r,            MODMASK                                         // AND i with MODMASK

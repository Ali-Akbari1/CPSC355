...
newCuboid:                                                                                                              // newCuboid function 
        ...
        mov             x19,       x8                                                                              // Move x8 to macro x19 for readability

        mov             w20,            0                                                                               // Assign w20 to 0
        str             w20,            [x19,      cuboid_origin +         point_x]                                // Store 0 to c.origin.x

        mov             w20,            0                                                                               // Assign w20 to 0
        str             w20,            [x19,      cuboid_origin +         point_y]                                // Store 0 to c.origin.y

        mov             w21,            2                                                                               // Assign w21 to 2
        str             w21,            [x19,      cuboid_base +           dimension_width]                        // Store 2 to c.base.width

        mov             w22,            2                                                                               // Assign w22 to 2
        str             w22,            [x19,      cuboid_base +           dimension_length]                       // Store 2 to c.base.length

        mov             w28,            3                                                                               // Assign w28 to 3
        str             w28,            [x19,      cuboid_height]                                                  // Store 3 to c.height

        ldr             w21,            [x19,      cuboid_base +           dimension_width]                        // Load c.base.width to register w21
        ldr             w22,            [x19,      cuboid_base +           dimension_length]                       // Load c.base.length to register w22
        ldr             w28,            [x19,      cuboid_height]                                                  // Load c.height to register w28
        
        mov             w20,            0                                                                               // Assign 0 to w20
        mul             w20,            w21,            w22                                                             // Do width*length = w20
        mul             w20,            w28,            w20                                                             // Do w20 = width*length*height
        str             w20,            [x19,      cuboid_volume]                                                  // Store the volume into c.volume
...
equalSize:                                                                                                              // equalSize function
        ...
        mov             w20,       FALSE                                                                           // Move FALSE into w20 macro 
        ...
        mov             w20,       TRUE                                                                            // If the cuboids are not equal to each other move TRUE into w20
        mov             w0,             w20                                                                        // Move the value of w20 into w0

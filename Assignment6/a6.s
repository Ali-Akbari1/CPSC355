...
openok:                                                     // Openok branch
    add     x22,     x29,    buf_s                   // Get base address of buffer

readfile:                                                   // Read file branch
    
    mov     w0,             fd_r                            // File descriptor of opened file
    mov     x1,             x22                      // 2nd argument is buffer
    ...
    ldr     d0,             [x22]                    // First argument for e^x
    ...
    ldr     d0,             [x22]                    // Load d0 with buffer
